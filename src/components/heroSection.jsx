        ...
        <div className="grid md:grid-cols-2 items-center">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-left">
              <Button
                size="lg"
                className="background-[#003566]/90 !text-primary-foreground hover:!bg-custom-cta/90 px-8 py-3"
              >
                Schedule a demo
                <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
              <Button
                onClick={goFeaturesSection}
                variant="outline"
                size="lg"
                className="px-8 py-3 bg-primary/5 hover:bg-custom-green"
              >
                Learn More
              </Button>
            </div>
